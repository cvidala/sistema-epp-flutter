...
class SentryConfig {
  ...
  /// Inicializa Sentry. Solo activo en **release**: en debug el DSN queda
  /// vacío → SDK deshabilitado (sin ruido de desarrollo).
  ///
  /// No usa `appRunner`/`runZonedGuarded` a propósito: el `runApp` lo hace el
  /// entry point normalmente (evita el "zone mismatch" con la inicialización
  /// previa). El SDK igual captura crashes vía `FlutterError.onError` y
